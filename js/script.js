...
const questionBank = [
    ...
    {
        category: "work",
        text: "لو لقيت زميلك بيدخل لينكات مالهاش لازمة بالشغل طول اليوم؟",
        options: [
            { text: "أبلغ المدير على طول", score: 10 },
            { text: "ألمّح إن في حد مش مركز في شغله", score: 7.5 },
            { text: "أقول لزميل تاني نتكلم فيها", score: 5 },
            { text: "أسكت وأشتغل في شغلي", score: 2.5 },
            { text: "معايا برضو بفتح حاجات زي كده، مش شأني", score: 0 }
        ]
    },
    {
        category: "work",
        text: "لو زميلك جه متأخر عن الشغل وطلب منك تغطّيله قدام المدير؟",
        options: [
            { text: "أقول للمدير الحقيقة زي ما هي", score: 10 },
            { text: "أقوله اتأخر شوية من غير تفاصيل", score: 7.5 },
            { text: "أسكت ومقولش حاجة لحد ما يتسأل", score: 5 },
            { text: "أغطّيله بس أقوله متعملهاش تاني", score: 2.5 },
            { text: "أغطّيله زي ما هو محتاج", score: 0 }
        ]
    },
    {
        category: "work",
        text: "لو المدير وزّع مهمة جماعية وحد من الفريق مش بيعمل حاجة؟",
        options: [
            { text: "أقول للمدير إن فلان مش بيشتغل", score: 10 },
            { text: "ألمّح في الاجتماع إن الشغل مش متوزع كويس", score: 7.5 },
            { text: "أتكلم مع زميلي الكسول الأول", score: 5 },
            { text: "أشتغل نصيبه وسكت", score: 2.5 },
            { text: "أدّيله فرصة ومقولش لحد", score: 0 }
        ]
    },
    {
        category: "work",
        text: "لو سمعت زميلك بيدوّر على شغل تاني وهيسيب الشركة؟",
        options: [
            { text: "أقول للمدير فورًا عشان يستعد", score: 10 },
            { text: "ألمّح للمدير إن زميلي مش مبسوط", score: 7.5 },
            { text: "أقول لزميل تاني بس", score: 5 },
            { text: "أستناه هو يقول لما يكون جاهز", score: 2.5 },
            { text: "خبر يفضل عندي وبس", score: 0 }
        ]
    },
    {
        category: "work",
        text: "لو عرفت إن زميلك بياخد أجازات مرضية وهو مش تعبان؟",
        options: [
            { text: "أبلغ الموارد البشرية", score: 10 },
            { text: "ألمّح للمدير إن الموضوع غريب", score: 7.5 },
            { text: "أقول لزميل تاني نضحك عليها", score: 5 },
            { text: "أتريقله بس من غير ما أقول لحد", score: 2.5 },
            { text: "شأنه، مش لازم أتدخل", score: 0 }
        ]
    },
    ...
    {
        category: "friends",
        text: "لو صاحبك بعت في الجروب صورة محرجة له بالغلط وهو مش واخد باله؟",
        options: [
            { text: "أمسحها وأقوله يمسحها بسرعة", score: 0 },
            { text: "أبعتله برايفت إنه يمسحها", score: 2.5 },
            { text: "أسيبها وأستنى يلاحظ لوحده", score: 5 },
            { text: "أعمل لقطة شاشة الأول 😅", score: 7.5 },
            { text: "أعلّق عليها في الجروب قدام الكل 😂", score: 10 }
        ]
    },
    {
        category: "friends",
        text: "لو صاحبك سألك رأيك في صاحب تاني ليكم في حاجة شخصية؟",
        options: [
            { text: "أقوله رأيي بصراحة من غير ما أنقله لحد", score: 0 },
            { text: "أقوله رأيي بس أوضح إنه بينا إحنا الاتنين", score: 2.5 },
            { text: "أدّيله رأي عام من غير تفاصيل", score: 5 },
            { text: "أقول رأيي وبعدين أحكي للصاحب التالت اللي اتكلمنا عليه 😅", score: 7.5 },
            { text: "أعمل جروب وأحكي القصة كاملة 😂", score: 10 }
        ]
    },
    {
        category: "friends",
        text: "لو حجزت رحلة مع صحابك وواحد فيهم لغى في اللحظة الأخيرة من غير سبب واضح؟",
        options: [
            { text: "أتفهم وأسأله لو محتاج مساعدة", score: 0 },
            { text: "أتضايق بس ما بجيش الموضوع", score: 2.5 },
            { text: "أقوله رأيي في اللي حصل", score: 5 },
            { text: "أحكي لباقي الجروب إني مضايق منه", score: 7.5 },
            { text: "أعمل منها قصة وأخليه يحس بالذنب قدام الكل 😂", score: 10 }
        ]
    },
    {
        category: "friends",
        text: "لو صاحبك سألك تصدّقه في حاجة عملها ولاد بلده مش صح؟",
        options: [
            { text: "أصدقه وأحاول أفهم وجهة نظره", score: 0 },
            { text: "أصدقه بس أقوله رأيي بصراحة", score: 2.5 },
            { text: "أسمع وما أعلقش", score: 5 },
            { text: "أوافقه قدامه وأتريق عليه وراه 😅", score: 7.5 },
            { text: "أوافقه في وشه وأحكي للناس اللي عمله وراه 😂", score: 10 }
        ]
    },
    {
        category: "friends",
        text: "لو صاحبك بيحاول يبيّن قدام الناس إنه أحسن منك في حاجة إنتوا الاتنين بتعملوها؟",
        options: [
            { text: "أسيبه، مش لازم أثبت حاجة لحد", score: 0 },
            { text: "أرد بهدوء من غير ما أكبرها", score: 2.5 },
            { text: "أثبت له إني كويس برضو من غير ما أقلل منه", score: 5 },
            { text: "أتريق عليه شوية قدام الناس 😅", score: 7.5 },
            { text: "أفضحه بحاجة يعرفها بس هو عنه قدام كل الناس 😂", score: 10 }
        ]
    }
];
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('service-worker.js').catch(() => {
            /* offline support just won't be available — the game still works online */
        });
    });
}
